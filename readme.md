Python CLI Docstring Generator (doc_generator.py)
...
-The main CLI script.
sample_test.py
-Test file containing sync, async, and class functions.
requirements.txt
-Python dependency file (google-genai).
Key Features Implemented
AST Parsing & Filtering:
